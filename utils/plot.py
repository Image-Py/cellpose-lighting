...
def show_segmentation(fig, img, maski, flowi, channels=[0,0], file_name=None):
    ...
    if file_name is not None:
        ...
        io_cell.imsave(save_path + '_overlay.jpg', overlay)
        io_cell.imsave(save_path + '_outlines.jpg', imgout)
        io_cell.imsave(save_path + '_flows.jpg', flowi)
